...
public class ThaumcraftHandler {
	...
	private void registerCraftingRecipes() {
		crystalRecipe = ThaumcraftApi.addArcaneCraftingRecipe(KEY_CRYSTAL, new ItemStack(PlayerBeacons.crystalItem, 2), new AspectList().add(Aspect.ORDER, 10).add(Aspect.AIR, 10).add(Aspect.EARTH, 10).add(Aspect.FIRE, 10).add(Aspect.WATER, 10).add(Aspect.ENTROPY, 10), "cPO", "CEv", "oPV", 'c', ItemApi.getItem("itemShard", 0), 'C', ItemApi.getItem("itemShard", 1), 'o', ItemApi.getItem("itemShard", 2), 'O', ItemApi.getItem("itemShard", 3), 'v', ItemApi.getItem("itemShard", 4), 'V', ItemApi.getItem("itemShard", 5), 'P', new ItemStack(Items.ender_pearl), 'E', new ItemStack(Items.emerald));
		defiledConductorBlockRecipe = ThaumcraftApi.addArcaneCraftingRecipe(KEY_BEACON, new ItemStack(PlayerBeacons.defiledSoulConductorBlock, 4), new AspectList().add(Aspect.ORDER, 4), "OOO", "MMM", "OOO", 'O', new ItemStack(Blocks.obsidian), 'M', ItemApi.getBlock("blockCosmeticSolid", 6));
		defiledPylonBlockRecipe = GameRegistry.addShapedRecipe(new ItemStack(PlayerBeacons.defiledSoulPylonBlock, 2), "OPO", "G G", "OOO", 'O', new ItemStack(PlayerBeacons.defiledSoulConductorBlock), 'P', new ItemStack(Items.ender_pearl), 'G', new ItemStack(Items.gold_ingot));
		GameRegistry.addShapedRecipe(new ItemStack(PlayerBeacons.beheaderItem), "LIL", "IPI", "S S", 'P', new ItemStack(Blocks.piston), 'S', new ItemStack(Items.iron_sword), 'L', new ItemStack(Items.leather), 'I', new ItemStack(Items.iron_helmet));
	}
	...
	private void registerInfusionRecipes() {
		...
		for (int i = 0; i < 8; i++) {
			...
			else itemStacks[i] = new ItemStack(Items.ender_pearl);
		}
		beaconRecipe = ThaumcraftApi.addInfusionCraftingRecipe(KEY_BEACON, new ItemStack(PlayerBeacons.playerBeaconBlock), 7, new AspectList().add(Aspect.SOUL, 50).add(Aspect.ELDRITCH, 50).add(Aspect.AURA, 20).add(Aspect.MAGIC, 10), new ItemStack(Blocks.beacon), itemStacks);
	}
	...
	private void registerResearch() {
		...
		researchItem = new ResearchItem(KEY_DIMENSION, "BASICS", new AspectList(), -2, 7, 0, new ItemStack(Items.ender_pearl)).setRound().setAutoUnlock();
