...
public class FoxLibManager {
    ...
    public static boolean checkFoxlib() {
        if (!isFoxlibInstalled()) {
            ...
            if (FMLCommonHandler.instance().getEffectiveSide().isClient()) {
                ...
                String s = StatCollector.translateToLocalFormatted("foxlib.downloader.missing", PlayerBeacons.MOD_ID, foxlibDownloadFallback);
                FMLLog.bigWarning(s);
    ...
    public void onClientTick(TickEvent.ClientTickEvent e) {
        if (Minecraft.getMinecraft().currentScreen instanceof GuiMainMenu) {
            ...
            }, I18n.format("foxlib.downloader.0", PlayerBeacons.MOD_ID), I18n.format("foxlib.downloader.1"), 0));
        }
    }
