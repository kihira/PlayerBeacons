...
public class ModelPylonBase extends ModelBase {
	...
	public ModelPylonBase() {
		...
		Pillarstart1.setTextureSize(64, 64);
		...
		Pillarstart2.setTextureSize(64, 64);
		...
		PillarstartTop.setTextureSize(64, 64);
